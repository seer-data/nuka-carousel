...
function (_React$Component) {
  ...
  function Carousel() {
    ...
    _this.calcSlideHeightAndWidth = _this.calcSlideHeightAndWidth.bind(_assertThisInitialized(_this)); // this.handleKeyPress = this.handleKeyPress.bind(this);
  ...
  _createClass(Carousel, [{
    ...
    value: function bindEvents() {
      if (_exenv.default.canUseDOM) {
        ...
        (0, _utilities.addEvent)(document, 'visibilitychange', this.onVisibilityChange); // addEvent(document, 'keydown', this.handleKeyPress);
      }
    }
  }, {
    key: "onResize",
    ...
    value: function unbindEvents() {
      if (_exenv.default.canUseDOM) {
        ...
        (0, _utilities.removeEvent)(document, 'visibilitychange', this.onVisibilityChange); // removeEvent(document, 'keydown', this.handleKeyPress);
      }
    }
  }, {
